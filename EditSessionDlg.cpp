	...
	, m_bModified(false)
{
	...
	DEFINE_CTRLMSG_TABLE
		CMD_CTRLMSG(IDC_ADD,      BN_CLICKED, &CEditSessionDlg::OnAdd)
		CMD_CTRLMSG(IDC_MODIFY,   BN_CLICKED, &CEditSessionDlg::OnModify)
		CMD_CTRLMSG(IDC_DELETE,   BN_CLICKED, &CEditSessionDlg::OnDelete)
		CMD_CTRLMSG(IDC_RENAME,   BN_CLICKED, &CEditSessionDlg::OnRename)
		NFY_CTRLMSG(IDC_SESSIONS, NM_DBLCLK,  &CEditSessionDlg::OnGridDblClick)
	END_CTRLMSG_TABLE
